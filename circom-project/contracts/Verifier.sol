...
contract PlonkVerifier {
    ...
    uint256 constant Qmx  = 8012674133445140333855090271536082113943624097932057851117175595145502361410;
    uint256 constant Qmy  = 4686416024129310954739397168140883355661568373032992293342447054707498726673;
    uint256 constant Qlx  = 7669671920844603746868170082372493387672016448908360972955926430605016480863;
    uint256 constant Qly  = 18199668449767529353397342314440371687275789984097467611149691429922528349575;
    uint256 constant Qrx  = 7312510705272187721844193708111286743784218395629897596211670501728173184127;
    uint256 constant Qry  = 21695160138391747237078414564651370606342543449105122787990330692631594469771;
    uint256 constant Qox  = 13365682887030330693657923282570900416331675152419719974472101727744436882873;
    uint256 constant Qoy  = 2787817714250958868837162147267054631982102016388759467251490830338798529617;
    uint256 constant Qcx  = 4928947880404538342310154500983292887032902048563271922470128534281499198332;
    uint256 constant Qcy  = 19928452953825882917912141755725551873200479533474650452637866451010305951140;
    uint256 constant S1x  = 468890454411973619961259710575982204124491516105679412606460944641429109817;
    uint256 constant S1y  = 270304523431872278772786943026780162685247307444519008126324794879676651026;
    uint256 constant S2x  = 14080526511146859614510500736270444254699387550484715326236768929933463755983;
    uint256 constant S2y  = 21023390088129505767245493403403372317843183548924844361571708933303215787167;
    uint256 constant S3x  = 20227942611150148991152650406516977902532016953862551914549770007131061199393;
    uint256 constant S3y  = 17182213692191176271927019195278553343758712603566616599962550186155045419338;
    ...
    function verifyProof(uint256[24] calldata _proof,   uint256[24] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 512 ), calldataload(pA))
                mstore(add(mIn, 544 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 576 ), calldataload(pB))
                mstore(add(mIn, 608 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 640 ), calldataload(pC))
                mstore(add(mIn, 672 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 704), q) 
